 ...
 * @author krygin
 */
class AddNewAdminUserWindow extends Window implements FieldEvents.BlurListener{
    ...
    public AddNewAdminUserWindow(TestLayout adminUserManagement) {
    ...
    public void buttonClickRegistr() {
        if (isValid()) {
            ...
            if (!(GeneralController.checkUserName(userName))){
                ...
                adminUserManagement.refreshTableData();
                AddNewAdminUserWindow.this.close();
            } else {
