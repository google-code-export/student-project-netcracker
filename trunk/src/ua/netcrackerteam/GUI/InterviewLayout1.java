...
class InterviewLayout1 extends VerticalLayout implements Property.ValueChangeListener {
    ...
    public InterviewLayout1(String username, MainPage mainPage) {
        ...
        Interview selectedInterview = registration.getSelectedInterview(userName);
